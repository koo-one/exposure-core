...
const config: IncidentConfig = {
  ...
  affectedVaults: [
    ...
    },
    {
      ...
      status: "covering",
      statusNote:
        "Indirect exposure through Fluid on Plasma only. ~$70M repaid, remaining debt settlement in progress.",
    ...
    {
      source: "manual",
      name: "Fluid wstUSR-USDT/USDT-USDC",
      protocol: "fluid",
      chains: ["bsc"],
      status: "covering",
      statusNote:
